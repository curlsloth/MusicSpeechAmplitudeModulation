% generate 4 s lownoise noise
% Because the LNN will repeating itself after 1 s, I generate 4 1-s LNN and then concatenate them.

fs = 44100;
dur = 1; % duration for each excerpt
nExcerpt = 4; % number of excerpts
...
save('lnn_4s_20200603.mat','carrierLNN')
